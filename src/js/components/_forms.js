const Forms = () => {
  function initForm(form) {
    ...
    form.addEventListener('submit', (e) => {
      ...
      const isFormConfirmed = !(form.name === 'dran-n-drop' || form.name === 'file-uploader');
      ...
      function clearFrom() {
        ...
        if (form.id === 'dran-n-drop') {
          ...
          const _fileUploadBtn = form.querySelector('.file-upload-btn');
            ...
            .then(
              (response) => {
                ...
                if (resData === true) {
                  ...
                  if (isDragDrop) {
                    sendFormWithConfirm(data, currentTarget);
                  }  // Отправляем форму c файлом из drag-n-drop
                }
                _button.style.pointerEvents = 'auto';
              },
              (error) => {
